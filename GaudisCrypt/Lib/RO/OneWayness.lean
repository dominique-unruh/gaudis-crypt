...
private lemma ow_loop_body_inRange_chal_y_compl :
    (ow_loop_body ow_adv lazy_query).inFootprint (ow_challenge_y.footprint)ᶜ :=
  oracle_step_inFootprint_compl ow_challenge_y h_ow_adv_chal_y

include h_ow_adv_chal_y in
/-- `ow_loop q` preserves `ow_challenge_y`. -/
private lemma ow_loop_inRange_chal_y_compl (q : ℕ) :
    (ow_loop ow_adv q lazy_query).inFootprint (ow_challenge_y.footprint)ᶜ :=
  oracle_loop_n_inFootprint_compl ow_challenge_y h_ow_adv_chal_y q
